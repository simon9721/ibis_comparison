...
* pattern for reference SPICE timing-offset study.
* ============================================================
...
XREF in_dig oe_ref tx_out_ref in_sense_ref vdd_ref 0 SPICE_BUF

.include 'channel.sp'
Rsrc tx_out_ref tx_out 1u
Rterm n10b 0 85

.save V(in_dig) V(tx_out_ref) V(tx_out) V(n10b) V(in_sense_ref)
.tran 10p 45n
