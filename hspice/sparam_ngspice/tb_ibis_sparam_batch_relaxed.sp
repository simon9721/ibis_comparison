...
* Relaxed/gear1 variant for debugging S-parameter equivalent stability.
* ============================================================
.temp 27
.options method=gear maxord=1 reltol=1e-3 abstol=1e-9 vntol=1e-5 gmin=1e-10 trtol=10 itl4=200
