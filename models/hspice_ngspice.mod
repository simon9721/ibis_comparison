* ngspice variant: RDSW=0, PRWG=0, PRWB=0 to prevent femtosecond internal node stiffness
* Original: hspice.mod  (TSMC 180nm BSIM3v3 Level 49)
* Change: RDSW, PRWG, PRWB zeroed out in both nfet and pfet models.
* Reason: ngspice-46 creates explicit #source/#drain internal nodes when RDSW>0.
*   For small transistors (e.g. mx30 W=0.3um), RDSW=150 -> R_source=500 ohm,
*   C=CGSO*W=0.215fF -> tau=54fs -> sub-femtosecond timesteps -> simulation stalls.
* DATE: Dec  9/02
* LOT: T29B                  WAF: 6003
