* optimized_io_buffer_v11_nocoupling.sp
* Same transistor reference buffer as io_buf.sp, but with the explicit
* control-to-output feedthrough caps zeroed for spike-isolation experiments.
...
* Parasitics - control-to-output feedthrough caps zeroed for experiment
