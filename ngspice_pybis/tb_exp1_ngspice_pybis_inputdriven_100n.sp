* ============================================================
* Short ngspice smoke bench for pybis2spice input-driven model
* Same topology as tb_exp1_ngspice_pybis_inputdriven.sp, shorter stop time.
* ============================================================
...
write tb_exp1_ngspice_pybis_inputdriven_100n.raw V(tx_out) V(n10b) V(dig_q) V(in_dig) V(xdrv.ku) V(xdrv.kd)
.endc
