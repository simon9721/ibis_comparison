...
z41c.ibs is valid for Commercial Ambient Temperature Range 0C<=Tc<=95C
z41c_it.ibs is valid for Industrial Ambient Temperature Range -40C<=Tc<=95C
...
1. The on-die VDDQ-VSSQ decoupling circuit for DQ and DQS MUST be included 
   ...
   a. z41c_ondie_decoupling_alldq.ckt - includes VDDQ-VSSQ decoupling for all 
   ...
   b. z41c_ondie_decoupling_perdq.ckt - includes VDDQ-VSSQ decoupling for an 
      ...
      in parallel is equivalent to the z41c_ondie_decoupling_all.ckt circuit.
