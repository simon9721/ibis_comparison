* io_buf ChargeLimitedGateFull diagnostic/ngspice charge-limited Ku/Kd extraction
* Sweep case: short_pulse_500ps_high
* 500 ps high pulse with 1 ps edges, 50 ohm + 2 pF
.title io_buf ngspice ChargeLimitedGateFull diagnostic Ku/Kd extraction short_pulse_500ps_high
.temp 27
