* io_buf ngspice two-state residual + mean Kd recover two-state gate study
* Sweep case: short_pulse_1ns_high
* 1 ns high pulse before output settles, 1 ps edges, 50 ohm + 2 pF
.title io_buf ngspice ngspice two-state residual + mean Kd recover short_pulse_1ns_high
.temp 27
