* io_buf ValueMatchedReplayHybrid/ngspice value-matched replay extraction
* Sweep case: short_pulse_500ps_high
* 500 ps high pulse with 1 ps edges, 50 ohm + 2 pF
.title io_buf ngspice ValueMatchedReplayHybrid Ku/Kd extraction short_pulse_500ps_high
.temp 27
