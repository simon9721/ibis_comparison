* io_buf ngspice value-matched v1 bug reference value-matched replay redo
* Sweep case: short_pulse_1ns_high
* 1 ns high pulse before output settles, 1 ps edges, 50 ohm + 2 pF
.title io_buf ngspice ngspice value-matched v1 bug reference short_pulse_1ns_high
.temp 27
