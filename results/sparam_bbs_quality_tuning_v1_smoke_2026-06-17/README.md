...
Generated: 2026-06-16 19:49:17

## Summary

- Candidate metric rows: 4
- Selected channels: 1
- Independent PASS/WARN/FAIL: 0 / 1 / 0
- RX-through PASS/WARN/FAIL: 0 / 1 / 0
- RX voltage-shape PASS/WARN/FAIL: 0 / 1 / 0
- RX timing PASS/WARN/FAIL: 1 / 0 / 0
- Reflection PASS/WARN/FAIL: 0 / 0 / 1
- Full-model PASS/WARN/FAIL: 0 / 1 / 0
- Failed channels: 0
- HSPICE correlation rows: 1
- Successful HSPICE correlations: 1
- BBS extraction rows: 6
- BBS candidate metric rows: 3
- BBS ngspice smoke rows: 36
...
- `bbs_full_model`: PASS `0`, WARN `0`, FAIL `3`, unclassified `0`
- `full_vector_fit`: PASS `0`, WARN `1`, FAIL `0`, unclassified `0`
...
- BBS extraction success: `6/6` rows
- BBS extraction timeouts: `0`
- BBS HSPICE-compatible outputs: `3`
- BBS General SPICE outputs: `3`
- BBS independent PASS/WARN/FAIL: `0/0/3`
...
- `clean`: ok `2`, failed `0`, timeout `0`
- `lowfreq`: ok `2`, failed `0`, timeout `0`
- `reciprocity`: ok `2`, failed `0`, timeout `0`

### Best BBS Candidate Per Channel

- `Clarity_example_40c993a4`: `bbs_passivity2_gspice_clean` (best_bbs_metric_candidate), mode `passivity2`, preset `clean`, independent `FAIL`, RX `FAIL`, reflection `FAIL`, full `FAIL`, ngspice pass `True`, extractions `6/6`

### BBS Candidate Metric Rows

- `Clarity_example_40c993a4` `bbs_passivity2_gspice_clean`: independent `FAIL`, RX `FAIL`, reflection `FAIL`, full `FAIL`, wrapper `results/sparam_bbs_quality_tuning_v1_smoke_2026-06-17/channels/Clarity_example_40c993a4/models/bbs_passivity2_gspice_clean/Clarity_example_40c993a4_bbs_passivity2_gspice_clean_ngspice_wrapper.sp`
- `Clarity_example_40c993a4` `bbs_passivity2_gspice_reciprocity`: independent `FAIL`, RX `FAIL`, reflection `FAIL`, full `FAIL`, wrapper `results/sparam_bbs_quality_tuning_v1_smoke_2026-06-17/channels/Clarity_example_40c993a4/models/bbs_passivity2_gspice_reciprocity/Clarity_example_40c993a4_bbs_passivity2_gspice_reciprocity_ngspice_wrapper.sp`
- `Clarity_example_40c993a4` `bbs_passivity2_gspice_lowfreq`: independent `FAIL`, RX `FAIL`, reflection `FAIL`, full `FAIL`, wrapper `results/sparam_bbs_quality_tuning_v1_smoke_2026-06-17/channels/Clarity_example_40c993a4/models/bbs_passivity2_gspice_lowfreq/Clarity_example_40c993a4_bbs_passivity2_gspice_lowfreq_ngspice_wrapper.sp`

### BBS HSPICE Audit Overlays

- `Clarity_example_40c993a4` `bbs_passivity2_gspice_clean` `audit_amp1p5_edge5_r50`: HSPICE audit `FAIL`, RX `FAIL`, reflection `PASS`, RX active RMSE `0.04616932727721244` V, TX active RMSE `0.009369862836086965` V, rise delay delta `4.912230951641845` ps, RX plot `results/sparam_bbs_quality_tuning_v1_smoke_2026-06-17/plots/bbs_overlays/Clarity_example_40c993a4/rx/bbs_passivity2_gspice_clean_audit_amp1p5_edge5_r50_rx.png`, TX plot `results/sparam_bbs_quality_tuning_v1_smoke_2026-06-17/plots/bbs_overlays/Clarity_example_40c993a4/tx/bbs_passivity2_gspice_clean_audit_amp1p5_edge5_r50_tx.png`
- `Clarity_example_40c993a4` `bbs_passivity2_gspice_reciprocity` `audit_amp1p5_edge5_r50`: HSPICE audit `FAIL`, RX `FAIL`, reflection `PASS`, RX active RMSE `0.04616932727721244` V, TX active RMSE `0.009369862836086965` V, rise delay delta `4.912230951641845` ps, RX plot `results/sparam_bbs_quality_tuning_v1_smoke_2026-06-17/plots/bbs_overlays/Clarity_example_40c993a4/rx/bbs_passivity2_gspice_reciprocity_audit_amp1p5_edge5_r50_rx.png`, TX plot `results/sparam_bbs_quality_tuning_v1_smoke_2026-06-17/plots/bbs_overlays/Clarity_example_40c993a4/tx/bbs_passivity2_gspice_reciprocity_audit_amp1p5_edge5_r50_tx.png`

## Path-Level Readiness

- `rx_voltage_shape`: pass `0`, warn `1`, fail `0`
- `rx_timing`: pass `1`, warn `0`, fail `0`
- `rx_voltage_shape`: ready `0`, warn `1`, fail `0`, selected models `1`, HSPICE P/W/F/E `0/0/1/0`
- `rx_timing`: ready `1`, warn `0`, fail `0`, selected models `1`, HSPICE P/W/F/E `0/1/0/0`
- `rx`: ready `0`, warn `1`, fail `0`, selected models `1`, HSPICE P/W/F/E `0/0/1/0`
- `reflection`: ready `0`, warn `0`, fail `1`, selected models `0`, HSPICE P/W/F/E `1/0/0/0`
- `full_model`: ready `0`, warn `1`, fail `0`, selected models `0`, HSPICE P/W/F/E `0/0/1/0`
...
- `Clarity_example_40c993a4`: `vector_3r3c` (WARN, scope `general_multiport`), RX `RX_WARN_VOLTAGE_MARGIN`, RX-shape `WARN`, RX-timing `PASS`, reflection `FAIL`, full `WARN`, order `9`, RMS `0.0004875`, max SV `0.9984`, model `results/sparam_bbs_quality_tuning_v1_smoke_2026-06-17/selected_models/Clarity_example_40c993a4.sp`
