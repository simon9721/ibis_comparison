...
- `reduced_4p_dominant_delay_rc_reflect`: PASS `0`, WARN `2`, FAIL `0`, unclassified `0`
...
- `full_vector_fit`: selected `0`, independent P/W/F `0/0/0`, HSPICE P/W/F/E `0/0/0/0`
- `reduced_4p_dominant_delay_rc`: selected `2`, independent P/W/F `0/2/0`, HSPICE P/W/F/E `0/3/0/0`
...
- `reduced_4p_not_full_matrix`: channels `2`, audit rows `3`, HSPICE P/W/F/E `0/3/0/0`
- `rx_low_swing_metric_floor`: channels `2`, audit rows `3`, HSPICE P/W/F/E `0/3/0/0`
- `rx_settling_margin`: channels `2`, audit rows `3`, HSPICE P/W/F/E `0/3/0/0`
- `threshold_delay_confidence_low`: channels `2`, audit rows `3`, HSPICE P/W/F/E `0/3/0/0`
- `voltage_shape_ok_threshold_delay_low`: channels `2`, audit rows `3`, HSPICE P/W/F/E `0/3/0/0`

## Selected Models

- `Ch10_35_5F3N_f1_49905299`: `reduced_4p_dominant_delay_rc` (WARN, scope `matched_50ohm_reduced_4p`), order `9`, RMS `0.001045`, max SV `0.002948`, model `results/sparam_trust_workflow_calibration_v1_smoke_cisco_2026-06-09/selected_models/Ch10_35_5F3N_f1_49905299.sp`
- `Ch10_35_5F3N_f2_f23c49e2`: `reduced_4p_dominant_delay_rc` (WARN, scope `matched_50ohm_reduced_4p`), order `9`, RMS `5.251e-05`, max SV `3.318e-05`, model `results/sparam_trust_workflow_calibration_v1_smoke_cisco_2026-06-09/selected_models/Ch10_35_5F3N_f2_f23c49e2.sp`
