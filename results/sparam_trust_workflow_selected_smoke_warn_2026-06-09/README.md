...
- `Clarity_example_acf20e4a`: `vector_3r3c` (WARN), order `9`, RMS `0.0004875`, max SV `0.9984`, model `results/sparam_trust_workflow_selected_smoke_warn_2026-06-09/selected_models/Clarity_example_acf20e4a.sp`
...
- Independent `PASS`: HSPICE pass `0`, fail `0`, error `0`, total `0`
- Independent `WARN`: HSPICE pass `1`, fail `2`, error `0`, total `3`
