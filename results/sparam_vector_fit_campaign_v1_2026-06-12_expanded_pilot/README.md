...
Detailed interpretation: `FINDINGS.md`
...
- `vector_3r3c`: `48` rows, P/W/F `2/0/46`, selected `1`
- `vector_5r5c`: `48` rows, P/W/F `0/0/48`, selected `0`
- `vector_8r8c`: `47` rows, P/W/F `0/0/47`, selected `0`
- `vector_12r12c`: `45` rows, P/W/F `0/0/45`, selected `0`
- `vector_10r10c`: `44` rows, P/W/F `0/0/44`, selected `0`

## Preprocessing Outcomes

- `raw`: `60` candidate rows, P/W/F `2/0/58`, selected `1`
- `freq_trim_0p9`: `60` candidate rows, P/W/F `0/0/60`, selected `0`
- `dc_hold`: `56` candidate rows, P/W/F `0/0/56`, selected `0`
- `freq_trim_0p75`: `56` candidate rows, P/W/F `0/0/56`, selected `0`

## Passivity Enforcement

- `False`: `120` candidate rows, P/W/F `1/0/119`, selected `1`
- `True`: `112` candidate rows, P/W/F `1/0/111`, selected `0`
...
- `Clarity_example_4ef781de`: `raw_vector_3r3c_lin` (WARN), preprocess `raw`, order `9`, model `results/sparam_vector_fit_campaign_v1_2026-06-12_expanded_pilot/selected_vector_models/Clarity_example_4ef781de.sp`
