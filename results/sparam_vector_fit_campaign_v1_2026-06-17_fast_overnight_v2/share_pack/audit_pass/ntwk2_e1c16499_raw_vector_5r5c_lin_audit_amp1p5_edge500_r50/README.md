...
| `tx_active_rmse_v` | `0.0021890146312875357` |
| `tx_active_maxabs_v` | `0.0025827526650958887` |
| `rx_active_rmse_v` | `0.0010499973284028464` |
| `rx_active_maxabs_v` | `0.0017033056727694396` |
| `rx_minus_tx_rise50_ps_delta_ps` | `0.17129531082127247` |
| `rx_minus_tx_fall50_ps_delta_ps` | `-0.5191617559661932` |
