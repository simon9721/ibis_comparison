...
| `tx_active_rmse_v` | `0.006073187053749113` |
| `tx_active_maxabs_v` | `0.10259807628278647` |
| `rx_active_rmse_v` | `0.002785349301911984` |
| `rx_active_maxabs_v` | `0.05202966457478064` |
| `rx_minus_tx_rise50_ps_delta_ps` | `1.7741937251455768` |
| `rx_minus_tx_fall50_ps_delta_ps` | `1.7463584141605946` |
