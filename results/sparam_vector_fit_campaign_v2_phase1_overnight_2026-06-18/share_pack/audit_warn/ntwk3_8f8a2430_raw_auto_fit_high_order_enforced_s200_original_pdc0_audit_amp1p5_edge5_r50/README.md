# ntwk3_8f8a2430 - audit_amp1p5_edge5_r50

- Candidate: `raw_auto_fit_high_order_enforced_s200_original_pdc0`
...
| `tx_active_rmse_v` | `0.0004131693067637842` |
| `tx_active_maxabs_v` | `0.004024671566527749` |
| `rx_active_rmse_v` | `0.0020656137782337053` |
| `rx_active_maxabs_v` | `0.019332108356578392` |
| `rx_minus_tx_rise50_ps_delta_ps` | `1.1389645204528946` |
| `rx_minus_tx_fall50_ps_delta_ps` | `0.8476444781803565` |
| `hspice_threshold_delay_confidence` | `low` |
| `hspice_threshold_delay_confidence_reasons` | `hspice_tx_fall_threshold_ambiguous;hspice_tx_rise_threshold_ambiguous;ngspice_tx_fall_threshold_ambiguous;ngspice_tx_rise_threshold_ambiguous` |
