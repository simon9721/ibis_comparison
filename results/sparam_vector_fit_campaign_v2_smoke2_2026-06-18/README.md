...
- `Clarity_example_acf20e4a`: `raw_vector_3r3c_lin` (WARN), preprocess `raw`, order `9`, model `results/sparam_vector_fit_campaign_v2_smoke2_2026-06-18/selected_vector_models/Clarity_example_acf20e4a.sp`
