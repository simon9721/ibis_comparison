...
Study folder: `results/sparam_vector_fit_campaign_v2_smoke_2026-06-18`
...
- `raw`: `1` candidate rows, P/W/F `1/0/0`, selected `1`

## Passivity Enforcement

- `False`: `1` candidate rows, P/W/F `1/0/0`, selected `1`
...
- `Clarity_example_acf20e4a`: `raw_vector_3r3c_lin` (PASS), preprocess `raw`, order `9`, model `results/sparam_vector_fit_campaign_v2_smoke_2026-06-18/selected_vector_models/Clarity_example_acf20e4a.sp`
