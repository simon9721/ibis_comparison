...
| `tx_active_rmse_v` | `0.019802289828821894` |
| `tx_active_maxabs_v` | `0.11621607381524979` |
| `rx_active_rmse_v` | `0.05045201821084051` |
| `rx_active_maxabs_v` | `0.21054566537465125` |
| `rx_minus_tx_rise50_ps_delta_ps` | `-1.210555909132438` |
| `rx_minus_tx_fall50_ps_delta_ps` | `-46.91804979150073` |
